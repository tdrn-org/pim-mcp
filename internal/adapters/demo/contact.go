...
var contactData map[string]*domain.Contact = map[string]*domain.Contact{
	"12": {
		...
		FirstName:    "John",
		LastName:     "Smith",
		Emails:       []domain.EmailAddress{domain.NewEmailAddress("john.smith@nowhere.org", "private")},
		Phones:       []domain.PhoneNumber{domain.NewPhoneNumber("+0123456789", "private")},
		Organization: "",
		JobTitle:     "",
		Addresses:    []domain.PostalAddress{},
	...
	"34": {
		...
		FirstName:    "Jane",
		LastName:     "Miller",
		Emails:       []domain.EmailAddress{domain.NewEmailAddress("jane.miller@nowhere.org", "private")},
		Phones:       []domain.PhoneNumber{domain.NewPhoneNumber("+0123456789", "private")},
		Organization: "",
		JobTitle:     "",
		Addresses:    []domain.PostalAddress{},
	...
	"56": {
		...
		FirstName:    "The",
		LastName:     "Other",
		Emails:       []domain.EmailAddress{domain.NewEmailAddress("the.other@nowhere.org", "private")},
		Phones:       []domain.PhoneNumber{domain.NewPhoneNumber("+0123456789", "private")},
		Organization: "",
		JobTitle:     "",
		Addresses:    []domain.PostalAddress{},
